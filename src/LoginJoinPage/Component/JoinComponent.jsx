...
function join(){
    ...
    return(
        <div class = "join-container">
            <div class = "join-box">
                <form class = "join-input">
                <div style = {styles.join}>회원가입</div>
                <div style = {styles.textbox}>계정이 있으신가요?
                <Link to = {`/login/`} style = {styles.joinText}>로그인</Link>
                </div>
                    ...
                    <div class = "password-text">비밀번호 확인</div>
                        <input type="password" className="password" />
                    <div>
                        <input type="submit" value="가입하기" class = "join-button"/>
                    </div>
                    <div class="join-line">
                        간편 회원가입
                    </div>
